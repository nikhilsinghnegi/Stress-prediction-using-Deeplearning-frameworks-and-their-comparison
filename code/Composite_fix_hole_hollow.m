...
%% Starting loop to generate series of geometry

data_set = 1000;

folder_path = 'D:\8th sem\BTP_II\DiNN-framework-Stress-Prediction-for-Heterogeneous-Media-master\Data processing\Plate with circular cutout model\check_here2\'; % 'C:\Temp_Abaqus\micro_meter_model\fix_hole_hollow_small\'
...
pa1 = 'plate_with_circular_cutout'; % 'composite_model'
pa2 = strcat('_',id);
pa3 = '.inp';
...
exname = strcat('*INCLUDE, INPUT=plate_with_circular_cutout','_',idx,'.inp');%composite_model

cac{1}{4} = exname;% input file name
