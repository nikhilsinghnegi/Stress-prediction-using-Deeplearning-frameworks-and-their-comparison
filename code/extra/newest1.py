...
#
#%% Import Modules
import tensorflow as tf  #or add maybe from tensorflow import keras
tf.compat.v1.enable_eager_execution() #maybe can remove that here in TF2.0
import os
import numpy as np
...
# Choose GPU to use
os.environ["CUDA_DEVICE_ORDER"]="PCI_BUS_ID"; ## created an environmental variable
...
# Calculate the geometry and stress difference contour for Training set, Cross-validation set and Test set
